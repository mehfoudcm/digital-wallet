...
#ALL FEATURES PRODUCING 4 output#.txt FILES
#PRODUCES MASTER TABLE AS WELL
...
#f = open('/Users/christophermehfoud/Desktop/test.csv','rU')
...
#writes the price over cap indicator and pathlength onto the database already including countpersec
